...
import fitShaderCode from './shaders/fit.glsl?raw'
import gridShaderCode from './shaders/grid.glsl?raw'
import particleShaderCode from './shaders/particle.glsl?raw'
import particleInitShaderCode from './shaders/particleInit.glsl?raw'
import particleUpdateShaderCode from './shaders/particleUpdate.glsl?raw'
...
export default class HelloRenderer {
    ...
    async init() {
        ...
        const gl = this.gl
        this.fitShader = gll.createShader(gl, fitShaderCode)
        this.gridShader = gll.createShader(gl, gridShaderCode)
        this.particleShader = gll.createShader(gl, particleShaderCode)
        this.particleInitShader = gll.createShader(gl, particleInitShaderCode)
